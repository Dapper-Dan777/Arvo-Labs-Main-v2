            ...
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link href="/">{t.documentation.breadcrumb.home}</Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
            ...
            <Card className="hover:border-primary/50 transition-colors">
              ...
              <CardFooter>
                <Button variant="opux" className="w-full" asChild>
                  <Link href="/dokumentation/was-ist-arvo-labs">
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <Card className="hover:border-primary/50 transition-colors">
              ...
              <CardFooter>
                <Button variant="opuxOutline" className="w-full" asChild>
                  <Link href="/dokumentation/dashboard-workspaces">{t.documentation.features.dashboard.button}</Link>
                </Button>
              </CardFooter>
            </Card>
            ...
            <Card className="hover:border-primary/50 transition-colors">
              ...
              <CardFooter>
                <Button variant="opuxOutline" className="w-full" asChild>
                  <Link href="/dokumentation/ki-chat-assistenten">{t.documentation.features.aiChat.button}</Link>
                </Button>
              </CardFooter>
            </Card>
            ...
            <Card className="hover:border-primary/50 transition-colors">
              ...
              <CardFooter>
                <Button variant="opuxOutline" className="w-full" asChild>
                  <Link href="/dokumentation/dokumente-wissensbasis">{t.documentation.features.documents.button}</Link>
                </Button>
              </CardFooter>
            </Card>
            ...
            <Card className="hover:border-primary/50 transition-colors">
              ...
              <CardFooter>
                <Button variant="opuxOutline" className="w-full" asChild>
                  <Link href="/dokumentation/email-kommunikation">{t.documentation.features.email.button}</Link>
                </Button>
              </CardFooter>
            </Card>
            ...
            <Card className="hover:border-primary/50 transition-colors">
              ...
              <CardFooter>
                <Button variant="opuxOutline" className="w-full" asChild>
                  <Link href="/dokumentation/automationen-workflows">{t.documentation.features.automations.button}</Link>
                </Button>
              </CardFooter>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="hover:border-primary/50 transition-colors">
              ...
              <CardFooter>
                <Button variant="opuxOutline" className="w-full" asChild>
                  <Link href="/dokumentation/updates">
