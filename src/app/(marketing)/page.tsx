...
export default function Index() {
  ...
  // Redirect eingeloggte User zum Dashboard (nur wenn nicht explizit auf Startseite)
  // Erlaube eingeloggten Usern, die Startseite zu sehen, wenn sie explizit darauf navigieren
  useEffect(() => {
    if (isLoaded && isSignedIn) {
      // Prüfe ob User explizit auf Startseite bleiben will (Query-Parameter "stay")
      const urlParams = new URLSearchParams(window.location.search);
      if (!urlParams.has("stay")) {
        // Nur redirecten, wenn User nicht explizit auf Startseite bleiben will
        // Warte kurz, damit der User die Startseite kurz sehen kann
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-up opacity-0" style={{ animationDelay: "300ms" }}>
              ...
              <Button variant="opuxOutline" size="lg" asChild>
                <Link href="/funktionen">{t.hero.secondary}</Link>
              </Button>
            </div>
        ...
        <div className="container mx-auto">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="opuxOutline" size="lg" asChild>
                <Link href="/funktionen">{t.cta.secondary}</Link>
              </Button>
            </div>
          </div>
        </div>
